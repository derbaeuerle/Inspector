...
public class ServiceReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (mGadgetConfiguration == null) {
			...
			// context.getResources().openRawResource(R.raw.inspector));
	...
	private void createGadget(Context context, Element gadget) throws ClassNotFoundException, IllegalAccessException,
			InstantiationException {
		try {
			// Class<?> c =
			// Class.forName(gadget.getChildText(context.getString(R.string.configuration_gadgets)));
			//
			// boolean multi = Boolean.valueOf(gadget.getAttributeValue(
			// context.getString(R.string.configuration_multiinstance),
			// "false"));
			// Class gadgetClass =
